<div class="x_panel tile">
    <div class="x_title">
        <h2><i class="fa fa-book pull-left"></i> Permit Application</h2>
    ...
    <div class="x_content">
        ...
        <form action="<?php echo site_url('permit_application') ?>" method="get" >
...
<?php foreach($permit_application as $item) {
    $data['item'] = $item;
    $this->load->view('permit_application/modal', $data);
} ?>
