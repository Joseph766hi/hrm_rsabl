    <div class="col-md-12">
        <div class="x_panel tile">
            <div class="x_title">
                <h2><i class="fa fa-book pull-left"></i> Permit Application Report</h2>
            ...
            <div class="x_content">
                ...
                <form action="<?php echo site_url('permit_application/report') ?>" method="get" >
